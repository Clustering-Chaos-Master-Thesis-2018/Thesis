...
\newtcbtheorem[no counter]{Definitions}{Definition}%
{
enhanced,
  sharp corners,
...
\definecolor{newnewtextcolor}{HTML}{0000AA}

\iffalse
\newenvironment{newtext}[1][New text]
{%
    \def\FrameCommand
    {%
        \hspace{-10pt}
...
{\endMakeFramed}
\fi
%\newenvironment{newtext}{\color{newnewtextcolor}}{\ignorespacesafterend}
%Comment above live and uncomment this line to remove new text.
\newenvironment*{newtext}[1][New text]{}{}
