...
Cover: An example of a network with 200 nodes, clustered by the process presented in this thesis. Each colour represents a different cluster and the large nodes are cluster heads. \setlength{\parskip}{0.5cm}
